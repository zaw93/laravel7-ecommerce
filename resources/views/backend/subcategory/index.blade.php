      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Subcategory List</h6>
          ...
          <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('subcategory.create') }}" class="btn btn-icon btn-neutral">
              ...
              <tbody>
                @foreach ($subcategories as $subcategory)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('subcategory.edit', $subcategory) }}" class="btn btn-icon btn-info">
                        <span class="btn-inner--icon"><i class="far fa-edit"></i></span>
                      </a>
                      <button type="button" data-route="{{ route('subcategory.destroy', $subcategory) }}"
                        data-toggle="modal" data-target="#deleteModal" class="btn btn-icon btn-danger btn-delete">
