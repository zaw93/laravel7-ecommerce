      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Edit Subcategory Form</h6>
        ...
        <div class="card">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-12">
                <h3 class="mb-0">Edit Subcategory Form</h3>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form action="{{ route('subcategory.update', $subcategory) }}" method="POST">
              ...
              <h6 class="heading-small text-muted mb-4">Edit Existing Subcategory</h6>
              <div class="pl-lg-4">
